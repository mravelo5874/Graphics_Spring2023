...
bool TrimeshFace::intersectLocal(ray& r, isect& i) const
{
	...
	/*std::cout << "a: (" << a_coords.x << ", " << a_coords.y << ", " << a_coords.z << ")" << std::endl;
	std::cout << "b: (" << b_coords.x << ", " << b_coords.y << ", " << b_coords.z << ")" << std::endl;
	std::cout << "c: (" << c_coords.x << ", " << c_coords.y << ", " << c_coords.z << ")" << std::endl;

	std::cout << "norm: (" << n.x << ", " << n.y << ", " << n.z << ")" << std::endl;
	std::cout << "ray.v: (" << v.x << ", " << v.y << ", " << v.z << ")" << std::endl;
	std::cout << "ray.pos: (" << o.x << ", " << o.y << ", " << o.z << ")" << std::endl;*/
	...
	// make sure point in inside triangle
	if (ab >= 0 && bc >= 0 && ca >= 0)
	{
		...
		// set i values
		i.setBary(glm::dvec3(bary_coord_a, bary_coord_b, bary_coord_c));
