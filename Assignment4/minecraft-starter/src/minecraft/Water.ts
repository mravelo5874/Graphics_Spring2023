...
export class Water
{
    ...
    public update_chunk(_chunk: Vec2)
    {
        ...
        const corner_0: Vec4 = new Vec4([center.x - (Utils.CHUNK_SIZE * 1.5), this.level, center.y - (Utils.CHUNK_SIZE * 1.5), 1])
        const corner_1: Vec4 = new Vec4([center.x + (Utils.CHUNK_SIZE * 1.5), this.level, center.y - (Utils.CHUNK_SIZE * 1.5), 1])
        const corner_2: Vec4 = new Vec4([center.x + (Utils.CHUNK_SIZE * 1.5), this.level, center.y + (Utils.CHUNK_SIZE * 1.5), 1])
        const corner_3: Vec4 = new Vec4([center.x - (Utils.CHUNK_SIZE * 1.5), this.level, center.y + (Utils.CHUNK_SIZE * 1.5), 1])
